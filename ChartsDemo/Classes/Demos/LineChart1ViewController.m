...
//    [_chartView setMaxVisibleCount:600];
//
      _chartView.xAxis.gridLineDashLengths = @[@1.0, @1.0];
    [_chartView.xAxis setLabelPosition:XAxisLabelPositionBottom];
    
    _chartView.xAxis.labelCount = 2;
...
//    _chartView.rightAxis.enabled = NO;
    ...
    leftAxis._customAxisMax = YES;
    leftAxis._customAxisMin = YES;
    
    CGFloat fmax = fabs(max);
    CGFloat fmin = fabs(min);
    if (fmax > fmin) {
        max = fmax;
        min = 0 - fmax;
    } else {
...
//        leftAxis.labelPosition = LabelPosition.insideChart;
    
    [leftAxis setLabelPosition:YAxisLabelPositionInsideChart];
    [leftAxis setSpaceTop:0];
    [leftAxis setSpaceBottom:0];
//    [_chartView setMinOffset:0];
    
      [_chartView setMinOffset:15];
//    _chartView.rightAxis.enabled = YES;
    _chartView.dragEnabled = NO;
    _chartView.pinchZoomEnabled = NO;
//    _chartView._maxVisibleCount = 600;
    [_chartView setExtraOffsetsWithLeft:0 top:0 right:0 bottom:0];
//    [_chartView.leftAxis setDrawBottomYLabelEntryEnabled: YES];

    
    NSLog(@"cc leftAxis count = %ld", leftAxis.labelCount);
...
//    [_chartView setVisibleXRangeMaximum:600];
    
//        [_chartView setMaxVisibleCount:600];
//    [_chartView setVisibleXRangeWithMinXRange:600 maxXRange:600];
//        [_chartView setVisibleXRangeWithMinXRange:0 maxXRange:600];
    
    [_chartView setVisibleXRangeMinimum:600];
...
//        set1 = [[LineChartDataSet alloc] initWithValues:values];
